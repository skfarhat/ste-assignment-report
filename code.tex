...
% ADDED getAllCustomers() to main - this was needed to implement Feature7:Scneario1 showcasing the defect[xxx]

% ------------------------------------------
\subsubsection{Application exceptions}
% discuss why TaxEngineException is needed 
% 
% ------------------------------------------
